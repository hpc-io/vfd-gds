...
/*
 * Error handling for the GDS VFD
 */

#ifndef H5FDgds_err_h
#define H5FDgds_err_h
...
extern hid_t H5FDgds_err_stack_g;
extern hid_t H5FDgds_err_class_g;

#define H5FD_GDS_ERR_CLS_NAME "HDF5 GDS VFD"
#define H5FD_GDS_ERR_LIB_NAME "HDF5 GDS VFD"
#define H5FD_GDS_ERR_VER      "1.0.0"
 ...
 */
#define H5FD_GDS_GOTO_ERROR(err_major, err_minor, ret_val, ...)                    \
do {                                                                               \
    ...
    if (err_func) {                                                                \
        if (H5FDgds_err_stack_g >= 0 && H5FDgds_err_class_g >= 0) {                \
            H5Epush2(H5FDgds_err_stack_g, __FILE__, __func__, __LINE__,            \
                    H5FDgds_err_class_g, err_major, err_minor, __VA_ARGS__);       \
        }                                                                          \
        else {                                                                     \
 ...
 */
#define H5FD_GDS_DONE_ERROR(err_major, err_minor, ret_val, ...)                    \
do {                                                                               \
    H5E_auto2_t err_func;                                                          \
                                                                                   \
    /* Check whether automatic error reporting has been disabled */                \
...
do {                                                                               \
    ...
    (void)H5Eget_auto2(H5E_DEFAULT, &err_func, NULL);                              \
    if (err_func) {                                                                \
        if ((H5FDgds_err_stack_g >= 0) && (H5Eget_num(H5FDgds_err_stack_g) > 0)) { \
            H5Eprint2(H5FDgds_err_stack_g, NULL);                                  \
            H5Eclear2(H5FDgds_err_stack_g);                                        \
        }                                                                          \
    }                                                                              \
} while(0)
...
#define H5FD_GDS_SYS_GOTO_ERROR(err_major, err_minor, ret_val, str)                \
do {                                                                               \
    int myerrno = errno;                                                           \
    H5FD_GDS_GOTO_ERROR(err_major, err_minor, ret_val,                             \
 ...
 */
#define H5FD_GDS_GOTO_DONE(ret_val)                                                \
do {                                                                               \
    ret_value = ret_val;                                                           \
    goto done;                                                                     \
} while(0)
 ...
 */
#define H5FD_GDS_FUNC_LEAVE_API                                                    \
do {                                                                               \
    PRINT_ERROR_STACK;                                                             \
    return ret_value;                                                              \
} while(0)
